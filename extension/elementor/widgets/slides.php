...
class event_conference_widget_slides extends Widget_Base {
    public function get_categories() {
        return array( 'event_conference_widgets' );
    }

    public function get_name() {
        return 'event_conference_slides';
    }

    public function get_title() {
        return esc_html__( 'Slides Theme', 'event_conference' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'section_content',
            [
                'label' => esc_html__( 'Slides', 'event_conference' ),
            ]
        );
        ...
        $repeater->start_controls_tab( 'background', [ 'label' => esc_html__( 'Background', 'event_conference' ) ] );

        $repeater->add_control(
            'slides_image',
            [
                'label'     =>  esc_html__( 'Image', 'event_conference' ),
        ...
        $repeater->add_control(
            'background_size',
            [
                'label' => _x( 'Size', 'Background Control', 'event_conference' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'cover',
                'options' => [
                    'cover' => _x( 'Cover', 'Background Control', 'event_conference' ),
                    'contain' => _x( 'Contain', 'Background Control', 'event_conference' ),
                    'auto' => _x( 'Auto', 'Background Control', 'event_conference' ),
                ],
                'selectors' => [
        ...
        $repeater->add_control(
            'background_overlay',
            [
                'label' => esc_html__( 'Background Overlay', 'event_conference' ),
        ...
        $repeater->add_control(
            ...
            [
                'label' => esc_html__( 'Color', 'event_conference' ),
        ...
        $repeater->start_controls_tab( 'content', [ 'label' => esc_html__( 'Content', 'event_conference' ) ] );

        $repeater->add_control(
            'heading',
            [
                'label' => esc_html__( 'Title & Description', 'event_conference' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Slide Heading', 'event_conference' ),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => esc_html__( 'Click edit button to change this text. Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'event_conference' ),
                'show_label' => false,
            ]
        );
        ...
        $repeater->add_control(
            'button_text',
            [
                'label' => esc_html__( 'Button Text', 'event_conference' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Click Here', 'event_conference' ),
            ]
        );
        ...
        $repeater->add_control(
            'link',
            [
                'label'         =>  esc_html__( 'Link', 'event_conference' ),
                'type'          =>  Controls_Manager::URL,
                'label_block'   =>  true,
                'default'       =>  [
                    'is_external'   =>  'true',
                ],
                'placeholder'   =>  esc_html__( 'https://your-link.com', 'event_conference' ),
            ]
        );

        $repeater->end_controls_tab();

        $repeater->start_controls_tab( 'style', [ 'label' => esc_html__( 'Style', 'event_conference' ) ] );

        $repeater->add_control(
            'custom_style',
            [
                'label' => esc_html__( 'Custom', 'event_conference' ),
                'type' => Controls_Manager::SWITCHER,
                'description' => esc_html__( 'Set custom style that will only affect this specific slide.', 'event_conference' ),
            ]
        );
        ...
        $repeater->add_control(
            'horizontal_position',
            [
                'label' => esc_html__( 'Horizontal Position', 'event_conference' ),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'left' => [
                        'title' => esc_html__( 'Left', 'event_conference' ),
                        'icon' => 'eicon-h-align-left',
                    ],
                    'center' => [
                        'title' => esc_html__( 'Center', 'event_conference' ),
                        'icon' => 'eicon-h-align-center',
                    ],
                    'right' => [
                        'title' => esc_html__( 'Right', 'event_conference' ),
        ...
        $repeater->add_control(
            'vertical_position',
            [
                'label' => esc_html__( 'Vertical Position', 'event_conference' ),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'top' => [
                        'title' => esc_html__( 'Top', 'event_conference' ),
                        'icon' => 'eicon-v-align-top',
                    ],
                    'middle' => [
                        'title' => esc_html__( 'Middle', 'event_conference' ),
                        'icon' => 'eicon-v-align-middle',
                    ],
                    'bottom' => [
                        'title' => esc_html__( 'Bottom', 'event_conference' ),
        ...
        $repeater->add_control(
            'text_align',
            [
                'label' => esc_html__( 'Text Align', 'event_conference' ),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'left' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   =>  [
                    [
                        'heading' => esc_html__( 'Slider 1 Heading', 'event_conference' ),
                        'description' => esc_html__( 'Click edit button to change this text. Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'event_conference' ),
                        'button_text' => esc_html__( 'Click Here', 'event_conference' ),
                        'link' => '#'
                    ],
                    [
                        'heading' => esc_html__( 'Slider 2 Heading', 'event_conference' ),
                        'description' => esc_html__( 'Click edit button to change this text. Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'event_conference' ),
                        'button_text' => esc_html__( 'Click Here', 'event_conference' ),
                        'link' => '#'
                    ],
        ...
        $this->add_responsive_control(
            'slides_height',
            [
                'label' => esc_html__( 'Height', 'event_conference' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Slider Options', 'event_conference' ),
        ...
        $this->add_responsive_control(
            'content_max_width',
            [
                'label' => esc_html__( 'Content Width', 'event_conference' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_responsive_control(
            'slides_padding',
            [
                'label' => esc_html__( 'Padding', 'event_conference' ),
        ...
        $this->add_control(
            'heading_spacing',
            [
                'label' => esc_html__( 'Spacing', 'event_conference' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Button', 'event_conference' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'button_border_width',
            [
                'label' => esc_html__( 'Border Width', 'event_conference' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Border Radius', 'event_conference' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->start_controls_tab( 'normal', [ 'label' => esc_html__( 'Normal', 'event_conference' ) ] );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Background Color', 'event_conference' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'button_border_color',
            [
                'label' => esc_html__( 'Border Color', 'event_conference' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_tab( 'hover', [ 'label' => esc_html__( 'Hover', 'event_conference' ) ] );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Navigation', 'event_conference' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'conditions' => [
                    'relation' => 'or',
                    'terms' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Arrows', 'event_conference' ),
        ...
        $this->add_control(
            'arrows_size',
            [
                'label' => esc_html__( 'Arrows Size', 'event_conference' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 10,
        ...
        $this->add_control(
            'arrows_color',
            [
                'label' => esc_html__( 'Arrows Color', 'event_conference' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'arrows_color_hover',
            [
                'label' => esc_html__( 'Arrows Color Hover', 'event_conference' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'heading_style_dots',
            [
                'label' => esc_html__( 'Dots', 'event_conference' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
                'conditions' => [
                    'terms' => [
        ...
        $this->add_control(
            'dots_size',
            [
                'label' => esc_html__( 'Dots Size', 'event_conference' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 5,
        ...
        $this->add_control(
            'dots_color',
            [
                'label' => esc_html__( 'Dots Color', 'event_conference' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'dots_color_hover',
            [
                'label' => esc_html__( 'Dots Color Hover', 'event_conference' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
    ...
    ?>
        ...
        <div class="element-slides owl-carousel owl-theme" data-settings='<?php echo esc_attr( wp_json_encode( $event_conference_slider_settings ) ); ?>'>

            <?php

            foreach ( $settings['slides_list'] as $item ) :
                $event_conference_slides_link         =   $item['link'];
                        ...
                        <div class="element-slides__item--content">
                            ...
                            <?php if ( !empty( $item['button_text'] ) ) : ?>
                                <div class="element-slides__item--link">
                                    <?php if ( !empty( $event_conference_slides_link['url'] ) ) : ?>
                                        <a href="<?php echo esc_url( $event_conference_slides_link['url'] ); ?>" <?php echo ( $event_conference_slides_link['is_external'] ? 'target="_blank"' : '' ); ?>>
...
Plugin::instance()->widgets_manager->register_widget_type( new event_conference_widget_slides );